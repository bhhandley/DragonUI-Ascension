					...
					mainbars = {
						...
						args = {
							...
							scale_vehicle = {
								...
								min = 0.5, max = 2.0, step = 0.1,
								get = function() return addon.db.profile.mainbars.scale_vehicle end,
					...
					buttons = {
						...
						args = {
							only_actionbackground = {
								...
								get = function() return addon.db.profile.buttons.only_actionbackground end,
							...
							count = {
								...
								args = {
									show = {
										type = 'toggle',
										name = "Show Count",
										get = function() return addon.db.profile.buttons.count.show end,
							...
							hotkey = {
								...
								args = {
									...
									range = {
										...
										get = function() return addon.db.profile.buttons.hotkey.range end,
							...
							cooldown = {
								...
								args = {
									...
									min_duration = {
										...
										min = 1, max = 10, step = 1,
										get = function() return addon.db.profile.buttons.cooldown.min_duration end,
										set = createSetFunction("buttons", "cooldown", "min_duration", "RefreshCooldowns"),
										order = 2,
									},
									color = {
										type = 'color',
		...
		xprepbar = {
			...
			args = {
				bothbar_offset = {
					...
					get = function() return addon.db.profile.xprepbar.bothbar_offset end,
				...
				singlebar_offset = {
					...
					min = 0, max = 100, step = 1,
					get = function() return addon.db.profile.xprepbar.singlebar_offset end,
				...
				nobar_offset = {
					...
					min = 0, max = 100, step = 1,
					get = function() return addon.db.profile.xprepbar.nobar_offset end,
				...
				repbar_abovexp_offset = {
					...
					min = 0, max = 50, step = 1,
					get = function() return addon.db.profile.xprepbar.repbar_abovexp_offset end,
				...
				repbar_offset = {
					...
					min = 0, max = 50, step = 1,
					get = function() return addon.db.profile.xprepbar.repbar_offset end,
...
style = {
	...
	args = {
		...
		gryphon_previews = {
			type = 'description',
			name =
				"|cffFFD700Old|r:      |TInterface\\AddOns\\DragonUI\\assets\\uiactionbar2x_:96:96:0:0:512:2048:1:357:209:543|t |TInterface\\AddOns\\DragonUI\\media\\uiactionbar2x_:96:96:0:0:512:2048:1:357:545:879|t\n" ..
				...
				common_group = {
					...
					args = {
						size = {
							...
							get = function() return addon.db.profile.additional.size end,
							set = createSetFunction("additional", "size", nil, "RefreshStance RefreshPetbar RefreshVehicle RefreshMulticast"),
							order = 1,
							width = "half",
						},
						spacing = {
							...
							min = 0, max = 20, step = 1,
							get = function() return addon.db.profile.additional.spacing end,
							set = createSetFunction("additional", "spacing", nil, "RefreshStance RefreshPetbar RefreshVehicle RefreshMulticast"),
							order = 2,
							width = "half",
						},
					},
						...
						stance_group = {
							...
							args = {
								x_position = {
									...
									min = -500, max = 500, step = 1,
									get = function() return addon.db.profile.additional.stance.x_position end,
								...
								y_offset = {
									...
									get = function() return addon.db.profile.additional.stance.y_offset end,
						...
						pet_group = {
							...
							args = {
								x_position = {
									...
									min = -500, max = 500, step = 1,
									get = function() return addon.db.profile.additional.pet.x_position end,
								...
								y_offset = {
									...
									get = function() return addon.db.profile.additional.pet.y_offset or 0 end,
								...
								grid = {
									...
									get = function() return addon.db.profile.additional.pet.grid end,
						...
						vehicle_group = {
							...
							args = {
								...
								artstyle = {
									...
									get = function() return addon.db.profile.additional.vehicle.artstyle end,
						...
						totem_group = {
							...
							args = {
								x_position = {
									...
									min = -500, max = 500, step = 1,
									get = function() 
										return (addon.db.profile.additional.totem and addon.db.profile.additional.totem.x_position) or 0
									end,
								...
								y_offset = {
									...
									min = -100, max = 100, step = 1,
									get = function() 
										return (addon.db.profile.additional.totem and addon.db.profile.additional.totem.y_offset) or 0
									end,
		...
		minimap = {
			...
			args = {
				scale = {
					...
					get = function() return addon.db.profile.map.scale end,
				...
				border_alpha = {
					...
					get = function() return addon.db.profile.map.border_alpha end,
				...
				blip_skin = {
					...
					get = function() return addon.db.profile.map.blip_skin end,
				...
				player_arrow_size = {
					...
					get = function() return addon.db.profile.map.player_arrow_size end,
				...
				tracking_icons = {
					...
					get = function() return addon.db.profile.map.tracking_icons end,
				...
				skin_button = {
					...
					get = function() return addon.db.profile.map.skin_button end,
					set = function(info, val)
						addon.db.profile.map.skin_button = val				end,
					order = 7,
				},
				fade_button = {
					type = 'toggle',
					...
					get = function() return addon.db.profile.map.fade_button end,
					set = function(info, val)
				...
				zonetext_font_size = {
					...
					min = 8, max = 20, step = 1,
					get = function() return addon.db.profile.map.zonetext_font_size end,
				...
				zoom_in_out = {
					...
					get = function() return addon.db.profile.map.zoom_in_out end,
		...
		times = {
			...
			args = {
				clock = {
					type = 'toggle',
					name = "Show Clock",
					get = function() return addon.db.profile.times.clock end,
				...
				calendar = {
					type = 'toggle',
					name = "Show Calendar",
					get = function() return addon.db.profile.times.calendar end,
				...
				clock_font_size = {
					...
					min = 8, max = 20, step = 1,
					get = function() return addon.db.profile.times.clock_font_size end,
		...
		castbars = {
			...
			args = {
				...
				precision_time = {
					...
					set = function(info, val) addon.db.profile.castbar.precision_time = val end,
					order = 10,
				...
				precision_max = {
					...
					set = function(info, val) addon.db.profile.castbar.precision_max = val end,
					order = 11,
					disabled = function() return addon.db.profile.castbar.text_mode == "simple" end,
				},
				holdTime = {
				...
				x_position = {
					...
					min = -500, max = 500, step = 1,
					get = function() 
						return addon.db.profile.castbar.target and addon.db.profile.castbar.target.x_position or -20 
					end,
					set = function(info, val)
						if not addon.db.profile.castbar.target then
							addon.db.profile.castbar.target = {}
				...
				y_position = {
					...
					min = -500, max = 500, step = 1,
					get = function() 
						return addon.db.profile.castbar.target and addon.db.profile.castbar.target.y_position or -20 
					end,
					set = function(info, val)
						if not addon.db.profile.castbar.target then
							addon.db.profile.castbar.target = {}
				...
				reset_position = {
					...
					func = function()
						if not addon.db.profile.castbar.target then addon.db.profile.castbar.target = {} end
				...
				enabled = {
					...
					get = function() 
						if not addon.db.profile.castbar.focus then return true end
				...
				x_position = {
					...
					min = -500, max = 500, step = 1,
					get = function() 
						return addon.db.profile.castbar.focus and addon.db.profile.castbar.focus.x_position or -20 
					end,
					set = function(info, val)
						if not addon.db.profile.castbar.focus then
							addon.db.profile.castbar.focus = {}
				...
				y_position = {
					...
					min = -500, max = 500, step = 1,
					get = function() 
						return addon.db.profile.castbar.focus and addon.db.profile.castbar.focus.y_position or -20 
					end,
					set = function(info, val)
						if not addon.db.profile.castbar.focus then
							addon.db.profile.castbar.focus = {}
				...
				sizeX = {
					...
					min = 50, max = 400, step = 1,
					get = function() 
						return addon.db.profile.castbar.focus and addon.db.profile.castbar.focus.sizeX or 150 
					end,
					set = function(info, val)
						if not addon.db.profile.castbar.focus then
							addon.db.profile.castbar.focus = {}
				...
				sizeIcon = {
					...
					min = 10, max = 50, step = 1,
					get = function() 
						return addon.db.profile.castbar.focus and addon.db.profile.castbar.focus.sizeIcon or 20 
					end,
					set = function(info, val)
						if not addon.db.profile.castbar.focus then
							addon.db.profile.castbar.focus = {}
					...
					order = 8,
					disabled = function() 
						return not (addon.db.profile.castbar.focus and addon.db.profile.castbar.focus.showIcon)
					end,
				},
				text_mode = {
					type = 'select',
					...
					get = function() 
						return (addon.db.profile.castbar.focus and addon.db.profile.castbar.focus.text_mode) or "simple" 
					end,
					set = function(info, val)
						if not addon.db.profile.castbar.focus then
							addon.db.profile.castbar.focus = {}
				...
				precision_time = {
					...
					min = 0, max = 3, step = 1,
					get = function() 
						return (addon.db.profile.castbar.focus and addon.db.profile.castbar.focus.precision_time) or 1 
					end,
					set = function(info, val)
						if not addon.db.profile.castbar.focus then
							addon.db.profile.castbar.focus = {}
					...
					order = 10,
					disabled = function() 
						return (addon.db.profile.castbar.focus and addon.db.profile.castbar.focus.text_mode) == "simple"
					end,
				},
				precision_max = {
					type = 'range',
					...
					min = 0, max = 3, step = 1,
					get = function() 
						return (addon.db.profile.castbar.focus and addon.db.profile.castbar.focus.precision_max) or 1 
					end,
					set = function(info, val)
						if not addon.db.profile.castbar.focus then
							addon.db.profile.castbar.focus = {}
				...
				autoAdjust = {
					...
					get = function() 
						if not addon.db.profile.castbar.focus then return false end
				...
				holdTime = {
					...
					get = function() 
						return addon.db.profile.castbar.focus and addon.db.profile.castbar.focus.holdTime or 0.3 
					end,
					set = function(info, val)
						if not addon.db.profile.castbar.focus then
							addon.db.profile.castbar.focus = {}
				...
				holdTimeInterrupt = {
					...
					min = 0, max = 3.0, step = 0.1,
					get = function() 
						return addon.db.profile.castbar.focus and addon.db.profile.castbar.focus.holdTimeInterrupt or 0.8 
					end,
					set = function(info, val)
						if not addon.db.profile.castbar.focus then
							addon.db.profile.castbar.focus = {}
				...
				reset_position = {
					...
					func = function()
						if not addon.db.profile.castbar.focus then addon.db.profile.castbar.focus = {} end
		...
		chat = {
			...
			args = {
				enabled = {
					...
					get = function() return addon.db.profile.chat.enabled end,
				...
				x_position = {
					...
					get = function() return addon.db.profile.chat.x_position end,
					set = createSetFunction("chat", "x_position", nil, "RefreshChat"),
					order = 11,
					disabled = function() return not addon.db.profile.chat.enabled end,
				},
				y_position = {
					type = 'range',
					name = "Y Position",
					...
					min = 0, max = 1000, step = 1,
					get = function() return addon.db.profile.chat.y_position end,
				...
				size_x = {
					...
					get = function() return addon.db.profile.chat.size_x end,
				...
				size_y = {
					...
					get = function() return addon.db.profile.chat.size_y end,
				...
				scale = {
					...
					min = 0.5, max = 2.0, step = 0.1,
					get = function() return addon.db.profile.chat.scale end,
				...
				player = {
					...
					args = {
						...
						breakUpLargeNumbers = {
							...
							set = createSetFunction("unitframe", "player", "breakUpLargeNumbers", "RefreshUnitFrames"),
							order = 3,
						},
						textFormat = {
							type = 'select',
						...
						showHealthTextAlways = {
							...
							set = createSetFunction("unitframe", "player", "showHealthTextAlways", "RefreshUnitFrames"),
							order = 5,
						},
						showManaTextAlways = {
							type = 'toggle',
						...
						x = {
							...
							order = 7,
							disabled = function() return not addon.db.profile.unitframe.player.override end,
						},
						y = {
							type = 'range',
							name = "Y Position",
				...
				target = {
					...
					args = {
						...
						breakUpLargeNumbers = {
							...
							set = createSetFunction("unitframe", "target", "breakUpLargeNumbers", "RefreshUnitFrames"),
							order = 3,
						},
						textFormat = {
							type = 'select',
						...
						showHealthTextAlways = {
							...
							set = createSetFunction("unitframe", "target", "showHealthTextAlways", "RefreshUnitFrames"),
							order = 5,
						},
						showManaTextAlways = {
							type = 'toggle',
						...
						x = {
							...
							order = 8,
							disabled = function() return not addon.db.profile.unitframe.target.override end,
						},
						y = {
							type = 'range',
							name = "Y Position",
				...
				focus = {
					...
					args = {
						...
						showHealthTextAlways = {
							...
							set = createSetFunction("unitframe", "focus", "showHealthTextAlways", "RefreshUnitFrames"),
							order = 5,
						},
						showManaTextAlways = {
							type = 'toggle',
						...
						x = {
							...
							order = 7,
							disabled = function() return not addon.db.profile.unitframe.focus.override end,
						},
						y = {
							type = 'range',
							name = "Y Position",
				...
				pet = {
					...
					args = {
						scale = {
							...
							set = createSetFunction("unitframe", "pet", "scale", "RefreshUnitFrames"),
							order = 1,
						},
						breakUpLargeNumbers = {
							type = 'toggle',
							...
							set = createSetFunction("unitframe", "pet", "breakUpLargeNumbers", "RefreshUnitFrames"),
							order = 2,
						},
						enableThreatGlow = {
							type = 'toggle',
							...
							set = createSetFunction("unitframe", "pet", "enableThreatGlow", "RefreshUnitFrames"),
							order = 3,
						},
						showHealthTextAlways = {
							type = 'toggle',
							...
							set = createSetFunction("unitframe", "pet", "showHealthTextAlways", "RefreshUnitFrames"),
							order = 4,
						},
						showManaTextAlways = {
							type = 'toggle',
							...
							set = createSetFunction("unitframe", "pet", "showManaTextAlways", "RefreshUnitFrames"),
							order = 5,
						},
						override = {
							type = 'toggle',
							...
							set = createSetFunction("unitframe", "pet", "override", "RefreshUnitFrames"),
							order = 4,
						},
						x = {
							type = 'range',
							...
							set = createSetFunction("unitframe", "pet", "x", "RefreshUnitFrames"),
							order = 5,
							disabled = function() return not addon.db.profile.unitframe.pet.override end,
						},
						y = {
							type = 'range',
							name = "Y Position",
							...
							set = createSetFunction("unitframe", "pet", "y", "RefreshUnitFrames"),
							order = 6,
							disabled = function() return not addon.db.profile.unitframe.pet.override end,
						},
					},
				...
				party = {
					...
					args = {
						...
						showHealthTextAlways = {
							...
							set = createSetFunction("unitframe", "party", "showHealthTextAlways", "RefreshUnitFrames"),
							order = 5,
						},
						showManaTextAlways = {
							type = 'toggle',
						...
						x = {
							...
							order = 10,
							disabled = function() return not addon.db.profile.unitframe.party.override end,
						},
						y = {
							type = 'range',
							name = "Y Position",
